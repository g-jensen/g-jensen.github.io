...
var G__20646 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(result,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$excludes], null),cljs.core.conj,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.rest(value))));
var G__20647 = cljs.core.rest(values__$1);
result = G__20646;
values__$1 = G__20647;
continue;
} else {
var G__20648 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(result,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$includes], null),cljs.core.conj,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(value));
var G__20649 = cljs.core.rest(values__$1);
result = G__20648;
values__$1 = G__20649;
continue;
}
...
var _STAR_runner_STAR__orig_val__20650 = speclj.config._STAR_runner_STAR_;
var _STAR_reporters_STAR__orig_val__20651 = speclj.config._STAR_reporters_STAR_;
var _STAR_specs_STAR__orig_val__20652 = speclj.config._STAR_specs_STAR_;
var _STAR_color_QMARK__STAR__orig_val__20653 = speclj.config._STAR_color_QMARK__STAR_;
var _STAR_omit_pending_QMARK__STAR__orig_val__20654 = speclj.config._STAR_omit_pending_QMARK__STAR_;
var _STAR_full_stack_trace_QMARK__STAR__orig_val__20655 = speclj.config._STAR_full_stack_trace_QMARK__STAR_;
var _STAR_tag_filter_STAR__orig_val__20656 = speclj.config._STAR_tag_filter_STAR_;
var _STAR_runner_STAR__temp_val__20657 = (cljs.core.truth_(cljs.core.cst$kw$runner.cljs$core$IFn$_invoke$arity$1(config))?(function (){
...
var _STAR_reporters_STAR__temp_val__20658 = (cljs.core.truth_(cljs.core.cst$kw$reporters.cljs$core$IFn$_invoke$arity$1(config))?cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(speclj.config.load_reporter,cljs.core.cst$kw$reporters.cljs$core$IFn$_invoke$arity$1(config)):speclj.config.active_reporters());
var _STAR_specs_STAR__temp_val__20659 = cljs.core.cst$kw$specs.cljs$core$IFn$_invoke$arity$1(config);
var _STAR_color_QMARK__STAR__temp_val__20660 = cljs.core.cst$kw$color.cljs$core$IFn$_invoke$arity$1(config);
var _STAR_omit_pending_QMARK__STAR__temp_val__20661 = cljs.core.cst$kw$omit_DASH_pending.cljs$core$IFn$_invoke$arity$1(config);
var _STAR_full_stack_trace_QMARK__STAR__temp_val__20662 = (!((cljs.core.cst$kw$stacktrace.cljs$core$IFn$_invoke$arity$1(config) == null)));
var _STAR_tag_filter_STAR__temp_val__20663 = speclj.config.parse_tags(cljs.core.cst$kw$tags.cljs$core$IFn$_invoke$arity$1(config));
(speclj.config._STAR_runner_STAR_ = _STAR_runner_STAR__temp_val__20657);

(speclj.config._STAR_reporters_STAR_ = _STAR_reporters_STAR__temp_val__20658);

(speclj.config._STAR_specs_STAR_ = _STAR_specs_STAR__temp_val__20659);

(speclj.config._STAR_color_QMARK__STAR_ = _STAR_color_QMARK__STAR__temp_val__20660);

(speclj.config._STAR_omit_pending_QMARK__STAR_ = _STAR_omit_pending_QMARK__STAR__temp_val__20661);

(speclj.config._STAR_full_stack_trace_QMARK__STAR_ = _STAR_full_stack_trace_QMARK__STAR__temp_val__20662);

(speclj.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR__temp_val__20663);

try{return (action.cljs$core$IFn$_invoke$arity$0 ? action.cljs$core$IFn$_invoke$arity$0() : action.call(null));
}finally {(speclj.config._STAR_tag_filter_STAR_ = _STAR_tag_filter_STAR__orig_val__20656);

(speclj.config._STAR_full_stack_trace_QMARK__STAR_ = _STAR_full_stack_trace_QMARK__STAR__orig_val__20655);

(speclj.config._STAR_omit_pending_QMARK__STAR_ = _STAR_omit_pending_QMARK__STAR__orig_val__20654);

(speclj.config._STAR_color_QMARK__STAR_ = _STAR_color_QMARK__STAR__orig_val__20653);

(speclj.config._STAR_specs_STAR_ = _STAR_specs_STAR__orig_val__20652);

(speclj.config._STAR_reporters_STAR_ = _STAR_reporters_STAR__orig_val__20651);

(speclj.config._STAR_runner_STAR_ = _STAR_runner_STAR__orig_val__20650);
}});
