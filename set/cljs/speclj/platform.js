...
return cljs.core._write(writer__4370__auto__,"speclj.platform/SpecFailure");
}));
...
return cljs.core._write(writer__4370__auto__,"speclj.platform/SpecPending");
}));
...
return cljs.core.rest(clojure.string.split_lines((function (){var or__4126__auto__ = e.stack;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return e.toString();
...
return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var or__4126__auto__ = e.stack;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
